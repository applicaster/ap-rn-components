...
describe("./ap-rn-components CLI interface", () => {
  ...
  describe("creates a package", () => {
    it("with a pretty index file", () => {
      expect(prettier.check(read("test-component-delete-me.js"))).toEqual(true);
    });
    ...
    it("with a package.json", () => {
      expect(pkgJson.name).toEqual(
        "@ap-rn-components/test-component-delete-me"
      );
    });
    ...
    it("with a pretty styles shared file", () => {
      expect(prettier.check(read("styles/shared.js"))).toEqual(true);
    });

    it("with a pretty styles index file", () => {
      expect(prettier.check(read("styles/index.js"))).toEqual(true);
    });

    it("with a pretty styles ios file", () => {
      expect(prettier.check(read("styles/index.ios.js"))).toEqual(true);
    });

    it("with a pretty styles android file", () => {
      expect(prettier.check(read("styles/index.android.js"))).toEqual(true);
    });
  });
});
