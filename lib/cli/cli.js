...
function writeStubFiles(variables) {
  ...
  mkdirp.sync(`${packageRoot}/__tests__/android`);
  mkdirp.sync(`${packageRoot}/__tests__/ios`);
  mkdirp.sync(`${packageRoot}/__tests__/web`);
  mkdirp.sync(`${packageRoot}/styles`);
...
function addComponent() {
  ...
  const usage =
    '\n\nUsage:\n$ ap-rn-components create component ComponentName "Component Description"';
